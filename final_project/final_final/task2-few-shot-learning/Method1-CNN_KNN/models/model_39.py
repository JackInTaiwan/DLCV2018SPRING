...
class Classifier(nn.Module) :
    def __init__(self):
        ...
        score_dense_chls = [conv_chls[-1] * 4 * 4, 2 ** 11, 2 ** 11, 80]

        self.fc_1 = self.fc(score_dense_chls[0], score_dense_chls[1], relu=True)
        self.fc_2 = self.fc(score_dense_chls[1], score_dense_chls[2], relu=False, sig=True)
    ...
    def pred(self, x_support, x_query) :
        ...
        for query in x_query.view(-1, 3, 32, 32) :
            ...
            query_feature = self.fc_2(query_feature)
